...
// Role color mapping for the UI badges
const roleColors = {
...
// --- END: Copied from users.jsx ---

// Helper function to convert URL slug (e.g., 'qc_member') to display title (e.g., 'QC Member')
...
export default function RoleUserList() {
    ...
    const fetchUsersByRole = async () => {
        ...
        try {
            ...
            // The URL slug (qc_member) is converted to uppercase (QC_MEMBER) for the API
            ...
            if (res.status === 200 && Array.isArray(res.data.users)) {
                ...
                // If 200 but data is not array (e.g., {users: null}), treat as no users
                setUsers([]); 
            }
        } catch (err) {
    ...
    // --- START: Update/Delete Logic from users.jsx (adapted for role list) ---

    // Function to handle the navigation for editing a user
    const handleEdit = (userId) => {
        // Navigates to the update user page, as in users.jsx
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            // The original users.jsx used a DELETE endpoint specific to admin for deletion.
    ...
    // --- END: Update/Delete Logic from users.jsx ---
