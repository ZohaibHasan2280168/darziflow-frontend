    ...
    <div className="role-selection-wrapper">
      <div className="container animated-gradient-border">
        ...
        <div className="button-container">
          {/* Updated: Added className "disabled-role" and changed onClick */}
          <button onClick={handleModeratorClick} className="role-button disabled-role">
      ...
      <style jsx>{`
        ...
        /* New Styles for Disabled/Coming Soon Role */
        .role-button.disabled-role {
          opacity: 0.65;
          cursor: not-allowed;
        }
        .role-button.disabled-role:hover {
          transform: none; /* Hover effect disabled */
