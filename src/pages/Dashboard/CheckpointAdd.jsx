...
export default function CheckpointAdd() {
 ...
 const handleSubmit = async (e) => {
  ...
  // Ensure context (dept/op) is available
  if (!deptId || !opId) {
  ...
  try {
    ...
    console.log('Creating checkpoint', { deptId, opId, payload });

    // Correct API: POST /api/departments/:deptId/operations/:opId/checkpoints
    const url = `${API_BASE}/departments/${deptId}/operations/${opId}/checkpoints`;
    console.debug('CheckpointAdd -> POST', url, { payload });
