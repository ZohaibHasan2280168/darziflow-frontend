  ...
  return (
    <div className="forgot-bg min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <style>{`
        ...
        .input-icon { position:absolute; right:12px; color: var(--text-muted); display:flex; align-items:center; justify-content:center; background:none; border:none; cursor:pointer; }
